...
namespace EFRelations.Infrastructure.Migrations
{
    ...
    [Migration("20190315185849_test1")]
    partial class test1
    {
            ...
            modelBuilder.Entity("EFRelations.Infrastructure.Data.Model.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredOn = new DateTime(2019, 3, 15, 20, 58, 48, 532, DateTimeKind.Local).AddTicks(7839)
                        },
                        new
                        {
                            StudentId = 2,
                            ...
                            PhoneNumber = "76876876868",
                            RegisteredOn = new DateTime(2019, 3, 15, 20, 58, 48, 537, DateTimeKind.Local).AddTicks(842)
                        },
                        new
                        {
                            StudentId = 3,
                            ...
                            PhoneNumber = "76876876868",
                            RegisteredOn = new DateTime(2019, 3, 15, 20, 58, 48, 537, DateTimeKind.Local).AddTicks(881)
                        });
                });
